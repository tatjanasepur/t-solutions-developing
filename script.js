...
// Smooth anchors (for one-page links, npr. sa indexa)
...
function wireForm(formId,noteId){
  const f=document.getElementById(formId) || document.getElementById('contactForm');
  const note=document.getElementById(noteId) || document.getElementById('contactNote');
  if(!f) return;
